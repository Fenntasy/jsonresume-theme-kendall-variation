...
Based on [the kendall theme](https://github.com/mchelen/jsonresume-theme-kendall) with some variations.
...
When you are finished with your resume, you may test it by yet again opening the command line and typing `resume serve --theme kendall-variation` to see how it looks with this theme. You can replace the word `kendall` with other theme names too.
